...
package net.mcreator.smpp.entity;
...
public class FireflyEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(SmppModEntities.FIREFLY.get(), 20, 4, 4));
	}

	public FireflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SmppModEntities.FIREFLY.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(SmppModItems.LIGHTESSENCE.get()));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FireflyEntity retval = SmppModEntities.FIREFLY.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.APPLE).contains(stack.getItem());
	}
	...
	public static void init() {
		SpawnPlacements.register(SmppModEntities.FIREFLY.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
