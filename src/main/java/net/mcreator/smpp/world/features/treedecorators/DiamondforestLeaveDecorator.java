...
public class DiamondforestLeaveDecorator extends LeaveVineDecorator {
	public static final DiamondforestLeaveDecorator INSTANCE = new DiamondforestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("diamondforest_tree_leave_decorator");
